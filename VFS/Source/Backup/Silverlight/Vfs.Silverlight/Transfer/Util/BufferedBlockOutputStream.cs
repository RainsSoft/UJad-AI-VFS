...
namespace Vfs.Transfer.Util
{
  ...
  public class BufferedBlockOutputStream : Stream
  {
    ...
    /// transmitted block. Returns null if no blocks have been transmitted
    /// yet.
    /// </summary>
    ...
    /// <see cref="BufferedDataBlock.Offset"/> property.
    ...
    public Action<BufferedDataBlock> OutputAction { get; protected set; }
