...
{
  /// <summary>
  /// A stream that provides streamed access to a block within
  ...
  public class ChunkStream : Stream
  {
    ...
    /// </summary>
    public Stream DecoratedStream { get; set; }
    ...
    public override long Position
    {
      ...
      set
      {
        ...
        {
          string msg = "Cannot set Position property to '{0}': Position cannot be negative or bigger than chunk size ({1}).";
        ...
        DecoratedStream.Position = value;
      }
    }
