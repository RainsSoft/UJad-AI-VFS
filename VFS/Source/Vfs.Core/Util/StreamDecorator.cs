...
{
  /// <summary>
  /// Decorates an arbitrary stream, and allows deriving classes to override
  /// specific properties or methods.
  /// </summary>
  public abstract class StreamDecorator : Stream
  {
    /// <summary>
    /// Initializes an empty decorator class that doesn't set the
    /// <see cref="DecoratedStream"/> property yet.
    /// </summary>
    ...
    {
      Ensure.ArgumentNotNull(decoratedStream, "decoratedStream");
    ...
    /// </summary>
    public virtual Stream DecoratedStream
    {
      get { return decoratedStream; }
      protected set { decoratedStream = value; }
    }
  ...
  public override bool CanSeek
  {
    ...
    /// </returns>
    /// <exception cref="T:System.InvalidOperationException">The <see cref="P:System.IO.Stream.ReadTimeout"/> method always throws an <see cref="T:System.InvalidOperationException"/>. 
    ...
    /// </returns>
    /// <exception cref="T:System.InvalidOperationException">The <see cref="P:System.IO.Stream.WriteTimeout"/> method always throws an <see cref="T:System.InvalidOperationException"/>. 
    /// </exception><filterpriority>2</filterpriority>
    ...
    /// </returns>
    /// <param name="buffer">The buffer to read the data into. 
    /// </param><param name="offset">The byte offset in <paramref name="buffer"/> at which to begin writing data read from the stream. 
    /// </param><param name="count">The maximum number of bytes to read. 
    /// </param><param name="callback">An optional asynchronous callback, to be called when the read is complete. 
    /// </param><param name="state">A user-provided object that distinguishes this particular asynchronous read request from other requests. 
    /// </param><exception cref="T:System.IO.IOException">Attempted an asynchronous read past the end of the stream, or a disk error occurs. 
    /// </exception><exception cref="T:System.ArgumentException">One or more of the arguments is invalid. 
    /// </exception><exception cref="T:System.ObjectDisposedException">Methods were called after the stream was closed. 
    /// </exception><exception cref="T:System.NotSupportedException">The current Stream implementation does not support the read operation. 
    /// </exception><filterpriority>2</filterpriority>
