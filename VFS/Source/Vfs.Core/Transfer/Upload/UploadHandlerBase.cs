        ...
        protected virtual void OrchestrateBlockWriting<T>(T dataBlock, Action<TTransfer, T> writerImplFunc) where T : class, IDataBlock {
            ...
            lock (transfer.SyncRoot) {
                ...
                if (!transfer.Status.Is(TransferStatus.Starting, TransferStatus.Running, TransferStatus.Paused)) {
                    ...
                    AuditHelper.AuditDeniedOperation(Auditor, context, AuditEvent.UploadNoLongerActive, transfer.FileItem as IVirtualFileItem, msg);
                ...
                AuditHelper.AuditResourceOperation(Auditor, context, AuditEvent.FileBlockUploaded, transfer.FileItem as IVirtualFileItem);
