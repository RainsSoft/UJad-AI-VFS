...
{
  /// <summary>
  /// A wrapper class that encasulates information about a given folder resource.
  /// Used by file system providers in order to handle requests that refer
  /// to that given folder.
  /// </summary>
  public abstract class VirtualFolderItem : IVirtualFolderItem
  {
    /// <summary>
    /// Gets the underlying resource.
    /// </summary>
    public VirtualFolderInfo ResourceInfo { get; set; }
