    ...
    public partial class ZipEntry
    {
        ...
        private static ZipEntry Create(string nameInArchive, ZipEntrySource source, Object arg1, Object arg2)
        {
            ...
            else
            {
                ...
                // workitem 6878??
                // Ionic.Zip.SharedUtilities.AdjustTime_Win32ToDotNet
                //TODO switched from UTC to local time, but should really use DateTimeOffset
                entry._Mtime = File.GetLastWriteTime(filename);
                entry._Ctime = File.GetCreationTime(filename);
                entry._Atime = File.GetLastAccessTime(filename);
                ...
                if(entry.IsDirectory)
                {
                  ...
                  {
                    entry._ExternalFileAttrs = new DirectoryInfo(filename).Attributes;
                  }
                }
                else
                {
        ...
        private static System.Text.Encoding ibm437 = new IBM437Encoding(); //NOTE changed System.Text.Encoding.GetEncoding("IBM437");
        private System.Text.Encoding _provisionalAlternateEncoding = new IBM437Encoding(); //System.Text.Encoding.GetEncoding("IBM437");
