...
namespace Ionic.Zip
{
    public partial class ZipFile
    {
        ...
        {
            return AddEntry(entryName, content, System.Text.Encoding.UTF8); //NOTE Changed from Encoding.Default to Encoding.UTF8
        }
        ...
        {
          return UpdateEntry(entryName, content, System.Text.Encoding.UTF8); //NOTE Changed from Encoding.Default to Encoding.UTF8
        }
