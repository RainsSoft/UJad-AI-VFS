...
namespace Vfs.LocalFileSystem
{
  public class LocalFileSystemProvider : FileSystemProviderBase2<FileItem, FolderItem>
  {
    ...
    /// </summary>
    public LocalFileSystemProvider() : this(Environment.MachineName)
    {
    }
    ...
    public LocalFileSystemProvider(string rootName) : this(LocalFileSystemConfiguration.CreateForMachine(rootName))
    {
    }
...
// ReSharper restore UseObjectOrCollectionInitializer
    ...
    public override FileItem ResolveFileResourcePath(string submittedFilePath, FileSystemTask context)
    {
    ...
    /// <exception cref="Exception">Any exceptions that are not derived from
    /// <see cref="VfsException"/> will be wrapped and audited.</exception>
    public override FolderItem ResolveFolderResourcePath(string submittedFolderPath, FileSystemTask context)
    {
      //make sure we operate on absolute paths
    ...
    protected override FolderItem GetFileSystemRootImplementation()
    {
    ...
    protected override IEnumerable<string> GetChildFolderPathsInternal(FolderItem parentFolder)
    {
    ...
    /// <paramref name="parentFolder"/>.</returns>
    protected override IEnumerable<string> GetChildFilePathsInternal(FolderItem parentFolder)
    {
    ...
    protected override FolderItem CreateFolderOnFileSystem(FolderItem folder)
    {
    ...
    protected override void DeleteFolderOnFileSystem(FolderItem folder)
    {
    ...
    protected override void DeleteFileOnFileSystem(FileItem file)
    {
    ...
    protected override void MoveFolderOnFileSystem(FolderItem sourceFolder, FolderItem targetFolder)
    {
    ...
    protected override void CopyFolderOnFileSystem(FolderItem sourceFolder, FolderItem targetFolder)
    {
    ...
    protected override void MoveFileOnFileSystem(FileItem sourceFile, FileItem targetFile)
    {
    ...
    /// <returns>Either the updated <paramref name="targetFile"/> instance, or a new
    /// <see cref="FileItem"/> instance that represents the created target file.</returns>
    protected override void CopyFileOnFileSystem(FileItem sourceFile, FileItem targetFile)
    {
    ...
    protected override Stream OpenFileStreamFromFileSystem(FileItem fileItem)
    {
    ...
    protected override void WriteFileStreamToFileSystem(FileItem fileItem, Stream input)
    {
    ...
    protected override List<string> GetResourceLockChain(FileItem file)
    {
    ...
    protected override List<string> GetResourceLockChain(FolderItem folder)
    {
      List<string> folders = new List<string>();
