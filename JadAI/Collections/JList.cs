...
namespace JadEngine.Collections
{
	/// <summary>
	/// This interface defines if an entity can be saved on a JList
	/// </summary>
	public interface IJListable
	{
		#region Properties
	...
	/// <summary>
	/// Base list used in the engine that can accept IJListable items
	/// </summary>
	/// <typeparam name="T">Type of the elements of the list. Must implement IJListable</typeparam>
	/// <remarks>
	/// The JList allows to access elements by ID or by Name, so it works like a List or a Dictionary
	...
	/// </remarks>
	public class JList<T> where T : IJListable
	{
		#region Fields
		...
		/// <summary>
		/// Gets the data of the JList as a List. Useful for the AddRange method
        /// </summary>
        public List<T> List
        {
            get { return listData; }
		...
		/// <summary>
		/// Gets the number of elements in the JList
		/// </summary>
		public int Count
		{
		...
		/// <summary>
		/// Tests if a name exists in the JList, and if true, returns the first element
		/// </summary>
		...
		/// <summary>
		/// Deletes an index from the JList
		/// </summary>
		...
		/// <summary>
		/// Returns the first element on the JList that has a certain name
		/// </summary>
	...
	/// <summary>
	/// Implements a special tipe of JList designed for objects as values (everything can enter the JList).
	/// It doesn´t allow repeated key values
	/// </summary>
	public class JListString
	{
		#region Fields
		...
		/// <summary>
		/// Gets the data of the JListString as a List. Useful for the AddRange method
		/// </summary>
		...
		/// <summary>
		/// Gets the number of elements in the JListString
		/// </summary>
		public int Count
		{
			get { return listData.Count; }
		...
		/// <summary>
		/// Tests if a key exists in the JListString
		/// </summary>
		...
		/// <summary>
		/// Adds an element to the JListString
		/// </summary>
		...
		/// <summary>
		/// Removes an element from the JListString using its key
		/// </summary>
	...
	/// </summary>
	/// <typeparam name="T">Class that the list will contain. Must implement IJListable</typeparam>
	public class JListUnique<T> where T : IJListable
	{
		#region Fields
