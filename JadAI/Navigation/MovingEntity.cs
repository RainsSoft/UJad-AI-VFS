...
using JMeshObject = UnityEngine.GameObject;
#endregion

namespace JadEngine.AI.Navigation
{
	/// <summary>
	...
	public abstract class MovingEntity : BaseEntity
	{
		...
		/// </summary>
		protected internal JMeshObject meshObject;
		...
		public virtual bool CanMoveBetween(Vector3 start, Vector3 end)
		{
            ...
            return !Physics.Raycast(start, dir.normalized, dir.magnitude, LayerMask.NameToLayer("Default"));
			//return !Physics.WorldRayCast(ref start, ref end, out parameter);
		}
		...
		{
            if (meshObject != null)
                UnityEngine.GameObject.DestroyObject(meshObject);
				//Jad.Scene.MeshObjects.Delete(meshObject);
		}
