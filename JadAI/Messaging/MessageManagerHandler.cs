...
namespace JadEngine.AI.Messaging
{
	...
	public sealed class MessageManagerHandler : IMessageManager
	{
		...
		/// </summary>
		internal Dictionary<MessageType, Dictionary<int, MessageHandlerDelegate>> registeredEntities;
		...
		public void UnregisterForMessage(MessageType type, int entityID)
		{
			if (registeredEntities[type] == null)
				return;
